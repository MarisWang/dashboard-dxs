...
import {passwordHeader, tableConfig} from "../../common/tableHeader";
...
export default class Users extends React.Component {
    ...
    getTableDatas = (limit, offset) => {
        ...
        setTimeout(() => {
            fetchDatas(`/audits/v1/password-change-log/?limit=${limit}&offset=${offset}`, result => {
                this.setState({
                    isLoading: false,
    ...
    onSearchTables = (value) => {
        ...
        fetchDatas(`/audits/v1/password-change-log/?limit=${limit}&offset=${offset}&search=${value}`, result => {
            this.setState({
                isLoading: false,
                tableDatas: result["results"],
                total: result.count
