...
import TeamLeaderDetails from "../viewMorePages/authDetails";
...
export default class AdminAuthorization extends React.Component {
    ...
    getTableDatas = () => {
        ...
        setTimeout(() => {
            fetchDatas(`/perms/v1/asset-permissions/?created_by=group_admin`, result => {
                this.setState({
                    isLoading: false,
                    tableDatas: result
                });
    ...
    onSearchTables = (value) => {
        this.setState({isLoading: true});
        fetchDatas(`/perms/v1/asset-permissions/?created_by=group_admin&search=${value}`, result => {
            this.setState({
                isLoading: false,
                tableDatas: result,
            });
            ...
            <div className="wrapper">
                ...
                <Table rowKey="id"
                       ...
                       expandedRowRender={record =>
                           <TeamLeaderDetails record={record} reloadData={this.getTableDatas}/>
                       }
                />
            </div>
        );
